...
const LoginPage=()=>{
    ...
    const handleEvent= async(e)=>{
        ...
        try{const response = await fetch(`https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=${API_KEY}`,{
            method:"POST",
        ...
        <Container className="d-flex justify-content-center align-items-center min-vh-100">
            <Row className="w-100 justify-content-center">
                <Col xs={10} sm={8} md={5} lg={4}>
                    ...
                    <Alert className="mt-3 shadow-sm" variant="primary">Don't have an account? <NavLink to="/signup">signup</NavLink></Alert>
                </Col>
            </Row>
        </Container>
    </>)
